...
if (domainName === 'chris.com.ph' || domainName === 'chrisfornesa.com' || domainName === 'cfornesa.com') 
{
    ...
    sideNav.innerHTML = `
        <a class="flex items-center gap-3 text-on-surface-variant p-4 hover:bg-white/5 uppercase text-xs tracking-[0.05em] hover:translate-x-1 transition-transform duration-300" href="../">
        <svg
        ...
        <a class="flex items-center gap-3 bg-primary/10 text-primary border-r-4 border-primary p-4 uppercase text-xs tracking-[0.05em] hover:translate-x-1 transition-transform duration-300" href="../readme">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="18"
            height="18"
